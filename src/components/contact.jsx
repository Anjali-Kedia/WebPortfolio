        ...
        <div name='contact' className='w-full h-screen items-center flex justify-center  p-8 mt-5 lg:mt-96 md:mt-96'>
            <form method='POST' action="https://getform.io/f/8cb733ec-a7dc-4f74-8b29-64ead005fa95" className='flex flex-col max-w-[1000px] w-full'>
                ...
                <p className='text-white py-4'>Feel free to fill in the form or shoot me an email - 24kedia.anjali@gmail.com </p>
                    ...
                    <input className='bg-black border-2 border-[#FFDDDB]  p-2 py-2 text-white' type="text" placeholder='Name' name='name' required />
                    <input className ='my-4 py-2 bg-black border-2 border-[#FFDDDB] p-2'type="Email" placeholder='Email' name='email' required />
                    <textarea className='bg-black border-2 border-[#FFDDDB] p-2' name="Message" rows='10' placeholder='Message' required ></textarea>
